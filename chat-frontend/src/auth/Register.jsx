...
import { Box, Paper, Typography, TextField, Button, Stack, Link, FormControlLabel, Checkbox } from "@mui/material";
...
export default function Register() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    const res = await auth.register({ username: username.trim(), password, rememberMe: remember });
    setLoading(false);
    if (res.ok) {
